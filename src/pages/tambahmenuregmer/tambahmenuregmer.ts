...
@IonicPage()
@Component({
  selector: 'page-tambahmenuregmer',
  templateUrl: 'tambahmenuregmer.html',
})
export class TambahmenuregmerPage {
  ...
  constructor(public navCtrl: NavController, 
    ...
    public domSanitizer: DomSanitizer) {
      this.back = RegmerPage;
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad TambahmenuregmerPage');
    // this.fetchMenus();
  }
